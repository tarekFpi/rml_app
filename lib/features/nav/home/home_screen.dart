...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void moveToTerminalDetails(Terminal terminal) async {
    FocusScope.of(context).unfocus();

    //initial delay for keyboard close
          ...
          children: <Widget>[
            ...
            Expanded(
              child: homeController.obx(
                      ...
                      child: ListView.builder(
                        itemBuilder: (ctx, index) {
                          ...
                          return Card(
                            ...
                            color: item.terminalStatus != TerminalStatus.ok
                            ...
                            child: InkWell(
                              ...
                              onTap: () {
                                //check if terminal is suspended
                                if (item.terminalStatus != TerminalStatus.ok) {
                                  Get.to(() => SuspendScreen(terminal: item,));
                                } else {
                              ...
                              child: ListTile(
                                ...
                                title: Row(
                                  children: [
                                    Flexible(
                                        child: Text(
                                      "${item.carrierRegistrationNumber}${item.carrierName == null || item.carrierName == "" ? "" : ", ${item.carrierName}"}",
                  ...
                  onLoading: const CustomListLoadingWidget(), onError: (msg) {
